  ...
  return (
    <>
      <div className="cookies-container">
        <h1>Cookie Policy for Nasa IPTV</h1>
        <p>
          This is the Cookie Policy for Nasa IPTV, accessible from
          https://nasaiptv.store/
        </p>
        ...
        <ul
          className="cookies-email"
          style={{ textAlign: "center", fontSize: "1.7rem", color: "magenta" }}
        >
          <li>Email: no-reply@nasaiptv.store</li>
        </ul>
      </div>
    </>
  );
